/*tịnh tổng các phần tử chẵn trong mảng

viết hàm copy mảng này sang mảng khác (copyArray)

viết hàm đảo ngược mảng bằng 2 dạng (reverseArray)

tính tổng các số lể trong mảng theo chiều đảo ngược */
